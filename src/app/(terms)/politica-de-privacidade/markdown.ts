...
A Viensoft construiu o aplicativo memorate como um aplicativo Freemium. Este SERVIÇO é fornecido pela Viensoft gratuitamente e deve ser usado como está.
...
Os termos utilizados nesta Política de Privacidade têm os mesmos significados que nos nossos Termos e Condições, que estão acessíveis em memorate, salvo definição em contrário nesta Política de Privacidade.

### Coleta e uso de informações

Para uma melhor experiência, ao usar nosso Serviço, podemos exigir que você nos forneça certas informações de identificação pessoal, incluindo, entre outras, nome, data de nascimento, imagens. As informações que solicitamos serão retidas por nós e utilizadas conforme descrito nesta política de privacidade.
...
Esta política entra em vigor a partir de 05/03/2024

### Contate-nos

Se você tiver alguma dúvida ou sugestão sobre nossa Política de Privacidade, não hesite em nos contatar em victor@cepil.dev.
`;
